...
var _yapLandRma = require("./k\xFCt\xFCphane/yap\u0131land\u0131rma");

var _fs = require("fs");

var _test = require("./k\xFCt\xFCphane/test");

var _test2 = _interopRequireDefault(_test);

var _yardMcLar = require("./k\xFCt\xFCphane/yard\u0131mc\u0131lar");

var _yNlendirici = require("./k\xFCt\xFCphane/y\xF6nlendirici");
 ...
 */
var httpSunucu = (0, _http.createServer)(function (istek, yanıt) {
...
var httpsSunucuAyarları = {
  ...
  key: (0, _fs.readFileSync)("./https/key.pem"),
  cert: (0, _fs.readFileSync)("./https/cert.pem")
};
 ...
 * Not: Sunucu her isteğe string ile karşılık vermeli
 */
var httpsSunucu = (0, _https.createServer)(httpsSunucuAyarları, function (istek, yanıt) {
  birleşikSunucu(istek, yanıt);
});
 ...
 */
httpSunucu.listen(_yapLandRma.httpBağlantıNoktası, function () {
  console.log("Sunucu " + _yapLandRma.httpBağlantıNoktası + " portundan dinleniyor.");
});
 ...
 */
httpsSunucu.listen(_yapLandRma.httpsBağlantıNoktası, function () {
  console.log("G\xFCvenli Sunucu " + _yapLandRma.httpsBağlantıNoktası + " portundan dinleniyor.");
});
 ...
 */
var birleşikSunucu = function birleşikSunucu(istek, yanıt) {
  /**
   * Url ayrıştırma işlemi
   * * Örnek: *{... query: {}, pathname: "/ornek" ... } şeklinde bir url classı*
   */
  var ayrıştırılmışUrl = (0, _url.parse)(istek.url, true);
   ...
   */
  var kodÇözücü = new _string_decoder.StringDecoder("utf-8");
  var tampon = "";
  ...
  istek.on("end", function () {
    ...
    var veri = {
      ...
      metot: metot,
      başlıklar: başlıklar,
      yükler: (0, _yardMcLar.jsonuObjeyeDönüştür)(tampon)
    };

    // İşleyiciyi ayarlıyoruz.
    (0, _yNlendirici.işleyiciAyarla)(kırpılmışYol, function (seçilmişİşleyici) {
      seçilmişİşleyici(veri, function (durumKodu, yükler) {
        ...
        yükler = (typeof yükler === "undefined" ? "undefined" : _typeof(yükler)) === "object" ? yükler : {};
...
//# sourceMappingURL=indeks.js.map